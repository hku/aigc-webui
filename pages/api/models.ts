import { AddonModel, AddonModelID, AndonModels } from '@/types/addon';
...
const handler = async (req: Request): Promise<Response> => {
  ...
  for (const name of addonsManifest as string[]) {
      ...
      models.push({id: name, ...(scriptModule.metadata || {name: 'unknown', description: "unknown"})});
    }
...
//     const models: AddonModel[] = json.data
//       .map((model: any) => {
